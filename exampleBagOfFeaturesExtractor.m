...
% detectMSERFeatures, or detectORBFeatures to select point locations. For
% instance:
%
...
% can be numeric or binary features. By default, bagOfFeatures extracts
% upright SURF features.
features = extractFeatures(grayImage, multiscaleGridPoints,'Upright',true);

% Alternatively, you may extract other features as well such as ORB, KAZE,
% or SIFT using the extraction 'Method' parameter of extractFeatures. For
% more information, see the documentation for extractFeatures.
